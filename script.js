...
const races = [
    ...
    "Sarkaz", "Liberi", "Sankta", "Deer", "Fishman", "Unknown", "Vampire", "Phoenix", "Giant", "Fairy", "Merfolk",
    "Gnome", "Troll", "Gargoyle", "Zombie", "Skeleton", "Harpy", "Minotaur", "Djinn", "Centaur", "Cyclops", 
    "Satyr", "Dryad", "Spirit", "Naga", "Undead", "Cyborg",
...
const regions = [
    ...
    "Emberstone Citadel", "Duskmire Reach", "Wildthorn Expanse", "Goldenleaf Glade", "Ivoryspire City", "San Andreas",
    "Saints City", "Slavic Valley"
];
const roleSkills = {
...
const faction = ["Tripacte Pacts", "Holy Empire", "Valley of Darkness", "Carcano Magic School", "Marine Corps"]
